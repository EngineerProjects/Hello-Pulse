  ...
  return (
    <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 dark:bg-gray-800">
      <form className="space-y-6" action="#" method="POST" onSubmit={submit}>
        ...
        {errorMessage && (
          <div
            className="flex items-center text-red-800 rounded-lg bg-red-50 dark:text-red-400 gap-4 px-2 dark:bg-red-800 p-3"
            role="alert"
          >
            <svg
      ...
      <div className="mt-6">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span
              className="px-2 bg-white text-gray-500 dark:text-gray-400 dark:bg-gray-800"
            >
              OR
            </span>
          </div>
